/**
 * WIP; This is a slight revision to the original STL Loader that was in the
 * Three.js examples repo. I did this because I didn't want to deal with a
 * global THREE namespace and wanted to use modules.
 *
 ...
 *
 * For binary STLs geometry might contain colors for vertices. To use it: // use
 * the same code to load STL as above if (geometry.hasColors) {material = new
 * THREE.MeshPhongMaterial({ opacity: geometry.alpha, vertexColors:
 * THREE.VertexColors });} else { .... } var mesh = new THREE.Mesh( geometry,
 * material );
 */

import {DefaultLoadingManager, FileLoader, BufferGeometry, BufferAttribute, Vector3} from 'three';
